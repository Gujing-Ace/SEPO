...
import ast
from transformers import AutoProcessor, BitsAndBytesConfig, Qwen2VLForConditionalGeneration, HfArgumentParser, Qwen2_5_VLForConditionalGeneration, AutoTokenizer

# from src.train.dpo_trainer import QwenDPOTrainer
# from src.train.data import make_dpo_data_module
from src.train.params import ModelArguments as BaseModelArguments, DataArguments
from src.train.params import TrainingArguments as SrcTrainingArguments
...
def train():
    ...
    data_module = make_sepo_data_module(model_id=model_args.model_id,
                                              processor=processor,
                                              data_args=data_args)
